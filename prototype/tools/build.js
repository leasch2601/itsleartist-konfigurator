 ...
 *
 * Das Ergebnis liegt in docs/ im Projektstamm - genau dort erwartet es
 * GitHub Pages - und wird mit eingecheckt, weil das hier benutzte sips nur
 * auf macOS existiert und auf GitHubs Linux-Maschinen nicht liefe.
 */
const fs = require('fs');
...
// Ohne diese Datei laesst GitHub Pages alles aus, was mit einem Unterstrich
// beginnt - dann fehlte ausgerechnet _vorschau.png.
...
console.log(`docs/ bereit zum Veroeffentlichen.`);
